...
export default async function ContactPage() {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-blue-700 to-blue-400 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl mb-8">Get in touch with us for all your plumbing needs.</p>
          </div>
        </section>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-700 to-blue-400 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Contact Us in {location.name}</h1>
          <p className="text-lg sm:text-xl mb-8">Get in touch with our local team in {location.name}, {location.state}.</p>
        </div>
      </section>
