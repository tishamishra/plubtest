    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-[#1c7bc8] to-[#0f4a75] text-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6">Expert Drain Repair Services</h1>
            <p className="text-xl mb-8 opacity-90">
              We fix damaged or leaking drains with precision across the US
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <nav className="text-sm">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-gray-400">/</li>
              <li className="text-[#1c7bc8]">Expert Drain Repair</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            {activeTab === "overview" && (
              <div>
                <h2 className="text-3xl font-bold mb-6">Expert Drain Repair Services</h2>
                <p className="text-lg text-gray-600 mb-6">
                  GD Professional Plumbing specializes in fixing damaged or leaking drains with precision across the US. We prevent backups, water damage, and ensure a smooth-flowing, reliable plumbing system in your home or business.
                </p>
                <p className="text-lg text-gray-600 mb-6">
                  With years of experience in drain repair, we provide comprehensive solutions that include leak detection, pipe repair, replacement, and preventive maintenance to keep your drainage system functioning properly.
                </p>
                
                {/* Call to Action Box */}
                <div className="bg-[#1c7bc8] text-white p-8 rounded-2xl mb-8">
                  <h3 className="text-2xl font-bold mb-4">Need Drain Repair Services?</h3>
                  <p className="text-lg mb-6 opacity-90">
                    Get expert drain repair services with precision and reliability.
                  </p>
                  <a
                    href="tel:+18334450128"
            ...
            {activeTab === "services" && (
              <div>
                <h2 className="text-3xl font-bold mb-8">Our Drain Repair Services</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Drain Pipe Repair</h3>
                    </div>
                    <p className="text-gray-600">
                      Professional repair of damaged or leaking drain pipes to restore proper flow.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <p className="text-gray-600">
                      Advanced leak detection services to locate hidden drain leaks and prevent water damage.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Pipe Replacement</h3>
                    </div>
                    <p className="text-gray-600">
                      Complete drain pipe replacement services for severely damaged or outdated systems.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <p className="text-gray-600">
                      Fast emergency drain repair services for urgent leaks and backup situations.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Precision Work</h3>
                    </div>
                    <p className="text-gray-600">
                      Expert precision in all drain repair work to ensure lasting solutions.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <p className="text-gray-600">
                      All our drain repair work comes with comprehensive warranty coverage.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <p className="text-gray-600">
                      Clear, upfront pricing with no hidden fees for all drain repair services.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  Contact us today for a free estimate on your drain repair project.
                </p>
      ...
      <section className="bg-[#1c7bc8] text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready for Drain Repair Services?</h2>
          <p className="text-xl mb-8 opacity-90">
            Get expert drain repair services with precision and reliability.
          </p>
          <a
