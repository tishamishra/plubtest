    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <nav className="text-sm">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-gray-400">/</li>
              <li className="text-[#1c7bc8]">Gas Line Installation & Repair</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            {activeTab === "overview" && (
              <div>
                <h2 className="text-3xl font-bold mb-6">Gas Line Installation & Repair Services</h2>
                <p className="text-lg text-gray-600 mb-6">
                  GD Professional Plumbing specializes in safe and code-compliant gas line installations, repairs, and replacements across the US. We power your appliances with confidence and protect your property from gas hazards.
                </p>
                <p className="text-lg text-gray-600 mb-6">
                  With years of experience in gas line services, we provide comprehensive solutions that include new installations, repairs, safety inspections, and emergency services to ensure your gas system operates safely and efficiently.
                </p>
                
                {/* Call to Action Box */}
                <div className="bg-[#1c7bc8] text-white p-8 rounded-2xl mb-8">
                  <h3 className="text-2xl font-bold mb-4">Need Gas Line Services?</h3>
                  <p className="text-lg mb-6 opacity-90">
                    Get professional gas line services with safety and code compliance.
                  </p>
                  <a
                    href="tel:+18334450128"
            ...
            {activeTab === "services" && (
              <div>
                <h2 className="text-3xl font-bold mb-8">Our Gas Line Services</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Gas Line Installation</h3>
                    </div>
                    <p className="text-gray-600">
                      Professional installation of new gas lines with proper sizing and safety compliance.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Gas Line Repair</h3>
                    </div>
                    <p className="text-gray-600">
                      Safe and reliable repair services for gas line leaks and damage.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Safety Inspections</h3>
                    </div>
                    <p className="text-gray-600">
                      Comprehensive gas line safety inspections to ensure code compliance and prevent hazards.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <p className="text-gray-600">
                      Fast emergency gas line services for urgent leaks and safety concerns.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Safety First</h3>
                    </div>
                    <p className="text-gray-600">
                      Safety is our top priority in all gas line work with proper testing and compliance.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl font-bold ml-4">Code Compliance</h3>
                    </div>
                    <p className="text-gray-600">
                      All gas line work meets local building codes and safety standards.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border">
                    ...
                    <p className="text-gray-600">
                      Clear, upfront pricing with no hidden fees for all gas line services.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  Contact us today for a free estimate on your gas line project.
                </p>
      ...
      <section className="bg-[#1c7bc8] text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">Ready for Gas Line Services?</h2>
          <p className="text-xl mb-8 opacity-90">
            Get professional gas line services with safety and code compliance.
          </p>
          <a
