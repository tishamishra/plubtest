  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">
            Find the Best Leak Detection & Repair Services
          </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm">
                    Professional leak detection and repair for homes with property protection.
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <h3 className="text-xl font-bold text-blue-700 mb-3">Commercial Services</h3>
                  <p className="text-gray-600 text-sm">
                    Large-scale leak detection solutions for businesses with minimal disruption.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img
                ...
                alt="Preventive Leak Inspection"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">We use state-of-the-art equipment to accurately locate leaks with precision.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Available round the clock for emergency leak detection and repair.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Non-Invasive Detection</h3>
              <p className="text-gray-600">We use advanced technology to detect leaks without damaging your property.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Our quality leak detection solutions are fairly priced to give you the best value.</p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Protect your home from water damage with our comprehensive residential leak detection and repair services. We understand that leaks can cause serious damage to your property, which is why we provide prompt, professional service with advanced detection technology.
              </p>
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Keep your business running smoothly with our comprehensive commercial leak detection and repair services. We understand that downtime costs money, so we provide fast, reliable service to minimize disruption to your operations.
              </p>
              <ul className="space-y-3 text-gray-600 mb-8">
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
      ...
      <section className="bg-[#1c7bc8] text-white py-16 px-4 mt-auto">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-8 animate-bounce">Need Leak Detection Services Today? Get a Free Quote Now</h2>
          <div className="mb-8">
            <a 
              href="tel:8334450128"
