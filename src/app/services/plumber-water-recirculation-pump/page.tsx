...
export const metadata: Metadata = {
  ...
  description: 'Professional water recirculation pump installation and repair services across the USA. Get instant hot water, save water, and boost plumbing efficiency. Licensed, insured, and trusted since 1973. Call (833) 445-0128.',
  keywords: [
