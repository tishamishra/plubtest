...
export const metadata: Metadata = {
  ...
  description: 'Professional water system installation, repair, and maintenance services across the USA. We deliver clean, safe, and uninterrupted water flow for residential and commercial properties. Licensed, insured, and trusted since 1973. Call (833) 445-0128.',
  keywords: [
