  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Look no further! GD Professional Plumbing is your trusted plumbing expert. We provide comprehensive tankless water heater solutions for both residential and commercial properties, with 24/7 emergency service availability.
              </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-gray-600 text-center mb-12 max-w-4xl mx-auto">
            GD Professional Plumbing Helps You with All Your Tankless Water Heater Projects including:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-blue-700 mb-3">» Tankless Water Heater Installation</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img
                ...
                alt="Tankless Water Heater Repair"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-blue-700 mb-3">» Tankless Water Heater Repair</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img
                ...
                alt="Tankless Water Heater Maintenance"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-blue-700 mb-3">» Tankless Water Heater Maintenance</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img
                ...
                alt="Tankless Water Heater Replacement"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-blue-700 mb-3">» Tankless Water Heater Replacement</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img
                ...
                alt="Tankless Water Heater Sizing"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <img
                ...
                alt="Emergency Tankless Water Heater Service"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
            Why Choose GD Professional Plumbing for Tankless Water Heater Installation?
          </h2>
          <p className="text-lg text-gray-600 text-center mb-12 max-w-4xl mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                From single-family homes to multi-unit properties, our residential tankless water heater installation services cover all your home hot water needs. We understand that hot water is essential for daily living, which is why we provide prompt, professional service with clear communication throughout the process.
              </p>
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Keep your business running smoothly with our comprehensive commercial tankless water heater installation services. We understand that downtime costs money, so we provide fast, reliable service to minimize disruption to your operations.
              </p>
              <ul className="space-y-3 text-gray-600 mb-8">
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
      ...
      <section className="bg-[#1c7bc8] text-white py-16 px-4 mt-auto">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-8 animate-bounce">Need Tankless Water Heater Installation Today? Get a Free Quote Now</h2>
          <div className="mb-8">
            <a 
              href="tel:8334450128"
