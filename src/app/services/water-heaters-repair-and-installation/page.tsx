...
export default function WaterHeaterServices() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col font-sans">
      ...
      {/* Hero Section */}
      <section className="relative py-20 px-4 bg-gradient-to-br from-[#1c7bc8] to-[#0f5a9e] text-white">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="bg-white text-[#1c7bc8] font-bold px-8 py-4 rounded-xl text-lg hover:bg-gray-50 transition shadow-lg inline-flex items-center justify-center"
              >
