...
interface ZipCodesAccordionProps {
  zipCodes: string[];
  cityName: string;
  stateName: string;
}

export default function ZipCodesAccordion({ zipCodes, cityName, stateName }: ZipCodesAccordionProps) {
  ...
  return (
    <div className="mb-12">
      <h3 className="text-2xl font-semibold mb-6 text-gray-800 text-center">
        Zip Codes We Serve in {cityName}
      </h3>
